...
| `f_ip_potongan` | potongan satu kelompok (`p_kelompok`: sekolah / koperasi) dalam rentang: satu baris satu potongan yang berjalan, nominal per bulan × bulan yang dipotong (dihitung seperti `f_ip_bulan`) |
