...
- Kehadiran staf sudah terbaca (tab Kehadiran Staf, dari `f_ip_kehadiran_staf`;
  ...
  dengan jam kerja, hari kerja, jam hadir, dan hari hadir belum dibuat.
  Bahan-bahannya sudah ada: kelompok tarif tiap staf dan hari serta jam
  kerja per minggunya dari Data Induk → Jam Kerja Staf (lewat
  `v_jam_kerja_guru`, kolom `kelompok_tarif`), jam dan hari hadir dari tab
  Kehadiran Staf. Batas indeks Tata Usaha dan Caraka/Satpam 1,0 (25
  September 2026).
