...
const rowItem = (no, uraian, ket, nominal) => new TableRow({ children: [
  ...
  sel(teks(ket || '', { color: '595959', italics: true }), KOL[2]),
...
function buatStruk(d) {
  ...
  const rincian = tabel(KOL, [
    rowHeader('A', 'PENDAPATAN SEBAGAI GURU'),
    ...
    rowHeader('C', 'HONOR GURU DIPERBANTUKAN'),
    ...
    rowItem(1, 'Transpor Piket Meja Sekolah', `${l.jamPiket} jam jaga`, l.piketMeja),
    ...
    rowItem(5, 'Kompensasi Piket Parkiran', `${l.hariParkir} hari jaga`, l.parkiran),
...
const contoh1 = {
  ...
  mengajar: { mapel: 'Bahasa Indonesia, Koordinator P5', jam: 33, jamTM: 118, hari: 21, honor: 1320000, transport: 546000, insentif: 590000, konsumsi: 169000 },
  wali: { kelas: 'XI IPS 2', honor: 325000, jamUpacara: 4, upacara: 80000, jamBimbingan: 7, bimbingan: 105000 },
  diperbantukan: { unit: 'Bidang Literasi', honor: 225000, jamJaga: 12, transport: 144000 },
  lain: { jamPiket: 8, piketMeja: 120000, gt: 3, pt: 2, inf: 0, pengganti: 75000, pertEkskul: 4, ekskul: 200000, pertTahfidz: 0, tahfidz: 0, hariParkir: 0, parkiran: 0 },
...
const contoh2 = {
  ...
  mengajar: { mapel: 'Pendidikan Pancasila, Sejarah', jam: 30, jamTM: 110, hari: 21, honor: 1200000, transport: 538000, insentif: 550000, konsumsi: 169000 },
  wali: { kelas: 'X 6', honor: 325000, jamUpacara: 4, upacara: 80000, jamBimbingan: 7, bimbingan: 105000 },
  diperbantukan: { unit: '–', honor: 0, jamJaga: 0, transport: 0 },
  lain: { jamPiket: 6, piketMeja: 90000, gt: 1, pt: 4, inf: 2, pengganti: 105000, pertEkskul: 0, ekskul: 0, pertTahfidz: 3, tahfidz: 150000, hariParkir: 0, parkiran: 0 },
